...
namespace Optern.Infrastructure.Migrations
{
    ...
    [Migration("20250131131553_addIsAcceptedToUserRoomTable")]
    partial class addIsAcceptedToUserRoomTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Optern.Domain.Entities.SubTrack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SubTracks", (string)null);
                });
            ...
            modelBuilder.Entity("Optern.Domain.Entities.RoomTrack", b =>
                {
                    ...
                    b.HasOne("Optern.Domain.Entities.SubTrack", "SubTrack")
                        .WithMany("RoomTracks")
                        .HasForeignKey("SubTrackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Room");

                    b.Navigation("SubTrack");
                });
