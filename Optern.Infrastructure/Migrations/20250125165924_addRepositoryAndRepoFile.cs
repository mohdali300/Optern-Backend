...
{
    /// <inheritdoc />
    public partial class addRepositoryAndRepoFile : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repository_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepositoryFile_Repository_RepositoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Repository_RoomId",
                table: "Repository",
                column: "RoomId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RepositoryFile_RepositoryId",
                table: "RepositoryFile",
                column: "RepositoryId");
        }
