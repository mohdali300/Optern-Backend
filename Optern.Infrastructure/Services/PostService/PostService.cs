namespace Optern.Infrastructure.Services.PostService
{
	public class PostService(IUnitOfWork unitOfWork, OpternDbContext context, IMapper mapper, ICacheService cacheService) : IPostService
	{
